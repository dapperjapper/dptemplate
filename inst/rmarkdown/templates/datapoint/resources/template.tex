...
\begin{titlepage}
  ...
  $if(qCCT)$
  {\color{black} \fontfamily{phv} \fontsize{10}{10} \selectfont \textbf{QUARTERLY CONSUMER CREDIT TRENDS}\\[10pt]
...
$endif$
$if(qCCT)$
This is part of a series of quarterly reports on consumer credit trends produced by the Bureau of Consumer Financial Protection using a longitudinal, nationally representative sample of approximately five million de-identified credit records from one of the three nationwide credit reporting agencies.
$else$
