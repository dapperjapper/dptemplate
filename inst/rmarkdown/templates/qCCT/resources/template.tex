...
\begin{titlepage}
  ...
  \ThisCenterWallPaper{0.35}{cfpblogo_wide}
  \vspace*{1.5in}
  {\color{black} \fontfamily{phv} \fontsize{38}{38} \selectfont Quarterly Consumer Credit Trends:\\[25pt]
  $dp_title$
  %\\[40pt]
  %\fontsize{14}{14} \selectfont The CFPB Office of Research\par}
\end{titlepage}
...
\begin{itemize}     % [label=\FilledSmallSquare]
 \renewcommand{\labelitemi}{\scriptsize\FilledSmallSquare}
  ...
  $endfor$
\end{itemize}
This is part of a series of quarterly reports of consumer credit trends produced by the Consumer Financial Protection Bureau using a longitudinal, nationally-representative sample of approximately five million de-identified credit records from one of the three nationwide credit reporting agencies.
\newpage
